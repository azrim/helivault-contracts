...
pragma solidity 0.8.26; // Upgraded to match your new config
    ...
    ReentrancyGuard
{
    ...
    uint256 public mintPrice; // Price is now in HLS (wei equivalent)
    ...
    ) ERC721("Helivault Cyphers", "HVC") Ownable(msg.sender) {
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(msg.value >= mintPrice * quantity, "Insufficient HLS payment");
    ...
    function withdraw() external onlyOwner nonReentrant {
        ...
        require(success, "HLS transfer failed.");
    }
